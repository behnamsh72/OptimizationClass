...
class WeightedEdge(Edge):
    def __init__(self, src, dest, total_distance, outdoor_distance):
        ...
        self.totalDistance = int(total_distance)
    ...
    def __str__(self):
        return ("%s->%s (%s, %s)" % (self.src, self.dest, self.totalDistance, self.outdoor_distance))
...
class Digraph(object):
    ...
    def add_edge(self, edge):
        ...
        add_edge_to_self_edges(self.edges, edge)

    def get_nodes(self):
        return self.nodes


def add_edge_to_self_edges(edges, edge):
