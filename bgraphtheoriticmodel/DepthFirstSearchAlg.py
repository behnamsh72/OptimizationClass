...
class Digraph(object):
    ...
    # return a list of childrens of a node
    def childrenOf(self, node):
        return self.edges[node]

    # if i want to know if a node is in the graph
...
# it's just a nice way of putting a wrap arount it that
# gets things started up
##here we can choose two Options DFS OR BFS
